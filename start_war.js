...
function startGame() {
    ...
    console.log("P1 DECK: " + globalPlayerOneDeck + " LENGTH " + globalPlayerOneDeck.length);
    console.log("P2 DECK: " + globalPlayerTwoDeck + " LENGTH " + globalPlayerTwoDeck.length);
}
...
//     users['player1']['score'] += 1;
//     users['player2']['score'] += 1;
//     console.log(users)
